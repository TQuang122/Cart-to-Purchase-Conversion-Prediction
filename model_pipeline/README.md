# MLflow Model System - Cart-to-Purchase Conversion Prediction

A production-ready MLOps system for training, evaluating, and managing XGBoost models for cart-to-purchase prediction using MLflow.
